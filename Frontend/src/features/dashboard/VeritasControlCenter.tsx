            ...
            <CardContent className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        ...
                        {visionResult && (
                            <pre className="text-[10px] bg-black/80 p-2 rounded border border-border/10 overflow-auto h-24 font-mono text-green-400">
                                {visionResult}
                            </pre>
                        )}
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-2">
                            ...
                            />
                            <Button onClick={handleExecute} disabled={status !== 'IDLE' || !goal.trim()} className="bg-cyan-600 hover:bg-cyan-700">
                                {status === 'EXECUTING' ? (
                                    <>
                                        <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                                        EXECUTING...
