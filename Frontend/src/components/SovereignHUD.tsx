                                ...
                                <div className="p-4 border-t border-[#2a2a50] bg-[#0a0a12]">
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className="p-3 bg-[var(--neon-cyan)] text-black rounded-xl hover:bg-[var(--neon-cyan)]/80 transition-all"
...
const NavItem = ({ icon: Icon, label, active, onClick, color }: { icon: any, label: string, active: boolean, onClick: () => void, color?: string }) => (
    <button
        ...
        onClick={onClick}
        className={`
            w-full flex items-center gap-3 px-4 py-3 rounded-lg cursor-pointer transition-all relative overflow-hidden group outline-none focus-visible:ring-2 focus-visible:ring-[var(--neon-cyan)]
