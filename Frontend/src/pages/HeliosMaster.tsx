        ...
        <div className="min-h-screen bg-[#020205] text-white p-8 font-['Outfit'] overflow-x-hidden relative">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <ProjectCard
                        name="Helios Command"
                        status={(metrics.projects?.["Helios Command"] as 'online' | 'offline' | 'degraded') || "offline"}
                    ...
                    <ProjectCard
                        name="Logos Mind"
                        status={(metrics.projects?.["Logos Mind"] as 'online' | 'offline' | 'degraded') || "offline"}
                    ...
                    <ProjectCard
                        name="Wealth Bridge"
                        status={(metrics.projects?.["Wealth Bridge"] as 'online' | 'offline' | 'degraded') || "offline"}
                    ...
                    <ProjectCard
                        name="SEO Auditor"
                        status={(metrics.projects?.["SEO Auditor"] as 'online' | 'offline' | 'degraded') || "offline"}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-[#0a0a12]/60 border border-[#2a2a50] rounded-2xl p-6 flex flex-col gap-4">
                        ...
                        <button
                            ...
                            className={`w-full py-4 border font-bold uppercase tracking-widest text-[10px] transition-all rounded-lg flex items-center justify-center gap-2 ${confirmPurge
